...
<!--              </div>-->
<!--            </b-modal>-->
<!--            <b-modal ref="my-modal" hide-footer title="Create New Driver">-->
...
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Driver Name:</label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text" v-model="form.drivername"></b-form-input>-->
<!--                      </b-col>-->
<!--                    </b-row>-->
<!--                    </br>-->
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Viewer List: </label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text" v-model="form.viewerlist"></b-form-input>-->
<!--                      </b-col>-->
<!--                    </b-row>-->
<!--                    </br>-->
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Driver Address:</label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text"-->
<!--                                      v-model="form.driveraddress"></b-form-input>-->
<!--                      </b-col>-->
<!--                    </b-row>-->
<!--                    </br>-->
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Phone No. :</label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text" v-model="form.phonenum"></b-form-input>-->
<!--                      </b-col>-->
<!--                    </b-row>-->
<!--                    </br>-->
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Lisence No.:</label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text" v-model="form.lisencenum"></b-form-input>-->
<!--                      </b-col>-->
<!--                    </b-row>-->
<!--                    </br>-->
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Lisence Expired</label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text"-->
<!--                                      v-model="form.lisenceexpired"></b-form-input>-->
<!--                      </b-col>-->
<!--                    </b-row>-->
<!--                    </br>-->
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">National ID No.</label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text"-->
<!--                                      v-model="form.nationalidnum"></b-form-input>-->
<!--                      </b-col>-->
<!--                    </b-row>-->
<!--                    </br>-->
<!--                    <b-row class="my-1">-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Driver Expired Date:</label>-->
<!--                      </b-col>-->
<!--                      <b-col sm="8">-->
<!--                        <b-form-input id="input-small" size="sm" type="text"-->
<!--                                      v-model="form.driverexpireddate"></b-form-input>-->
<!--                      </b-col>-->
<!--                      </br>-->
<!--                      <b-col sm="4">-->
<!--                        <label for="input-small">Driver Photo:</label>-->
<!--                      </b-col>-->
<!--                      </br>-->
<!--                      <b-col sm="8">-->
...
<!--                </td>-->
<!--                <td>-->
<!--                  <b-button id="show-btn" @click="edit(user)">Edit</b-button>-->
<!--                  <b-button id="show-btn" @click="showModal1">Delete</b-button>-->
<!--                </td>-->
<!--              </template>-->
